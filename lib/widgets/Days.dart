...
class Dayswid extends StatefulWidget {
  ...
  _DayswidState createState() => _DayswidState(
      Date: Date, Jour: Jour, document: document, index_of_day: index_of_day);
}
  ...
  Widget build(BuildContext context) {
   ...
   // print(_totalPoints.toString()+"this is the total points after loop");
    ...
    builder: (context, snapshot) {
      ...
      _totalPoints=snapshot.data.docs[index_of_day]["TotalPoints"];
      return Container(
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                              onTap: () {
                                setState(() {
                                  if (total_hour_points_constant[index_of_day] >0) {
                                    total_hour_points_constant[index_of_day] =
                                        total_hour_points_constant[index_of_day] - 1;
                                    DatabaseService(uid: uid_constant)
                                        .UpdatePointsTotal(
                                            'HourPoints',
                                            index_of_day,
                                        total_hour_points_constant[
                                                index_of_day]);
                                    total_points_constant[index_of_day]-=1;
                          ...
                          Container(
                            ...
                            child: Center(
                                child: Text(
                              '${total_hour_points_constant[index_of_day]}h',
                              style: GoogleFonts.heebo(
                          ...
                          InkWell(
                              onTap: () {
                                setState(() {
                                  if (total_hour_points_constant[index_of_day] <25) {
                                    total_hour_points_constant[index_of_day] =
                                        total_hour_points_constant[index_of_day] + 1;
                                    print('Checking index value${total_hour_points_constant[index_of_day]}');
                                    DatabaseService(uid: uid_constant)
                                        .UpdatePointsTotal(
                                            'HourPoints',
                                            index_of_day,
                                        total_hour_points_constant[index_of_day]);
                                    print('Checking index value again ${total_hour_points_constant[index_of_day]}');
                                    total_points_constant[index_of_day]+=1;
                                    DatabaseService(uid: user.uid).UpdatePointsTotal("TotalPoints", index_of_day,total_points_constant[index_of_day]);
                                  }
                                });
