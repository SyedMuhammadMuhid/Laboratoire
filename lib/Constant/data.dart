...
List profile_items=[ProfileListModel(name:'Actions', image_path: 'assets/actions_logo.png',screen: Home()), ProfileListModel(name:'Calendar', image_path: 'assets/calander_logo.png',screen: Home()),ProfileListModel(name:'Evolution', image_path: 'assets/evaluation_logo.png',screen: Home()),ProfileListModel(name:'Performances', image_path: 'assets/performance_logo.png',screen: Home()),ProfileListModel(name:'Notifications', image_path: 'assets/notification_logo.png',screen: NotificationScreen()),ProfileListModel(name:'Tips', image_path: 'assets/tips_logo.png', screen: TipsScreen()),ProfileListModel(name:'Help Page', image_path: 'assets/help_logo.png', screen: TipsScreen()),ProfileListModel(name:'Rate the app', image_path: 'assets/rate_logo.png',screen: TipsScreen())];
